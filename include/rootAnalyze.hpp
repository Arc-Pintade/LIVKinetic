...
// Fri May 11 13:03:56 2018 by ROOT version 6.12/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TLorentzVector *q, *qbar, *g1, *g2, *t, *tbar, *b, *lbar, *nu, *bbar, *l, *nubar;
   double *etal, *etalbar, *etab, *etabbar, *pTl, *pTlbar, *pTb, *pTbbar, *pTt, *pTtbar;
   bool* isFusion;

   Analyze(TString rootFile, TTree *tree=0);
   virtual ~Analyze();
