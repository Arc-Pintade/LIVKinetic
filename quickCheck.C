...
//    TH1F* hSME = k.statHistosConst("hSME", bkgd+ttbar);
   ...
   TFile* fOutput = new TFile("stats/statsfXX.root","RECREATE");
   hBkgd->Write();
   hTTbarSM->Write();
...
//_____________________ All needed parameters _____________________//
    ...
    double bkgdVal[2], sigVal[2];

           bkgdVal[0] = (34810*efficiency*15000/ratioSB);
           sigVal[0] = 34810*efficiency*15000;

           bkgdVal[1] = (34622*efficiency*15000/ratioSB);
           sigVal[1] = 34622*efficiency*15000;
    ...
    double test[5];
        ...
        for(int j=0; j<2; j++){
         ...
         createHistos(0, test[2], "D",false,bkgdVal[j],sigVal[j]);
...
//       createHistos(0, 0,1,0,0,true,(34810*efficiency*15000/ratioSB),(34810*efficiency*15000));
            ...
            ttbar.AddNormFactor("SigXsecOverSM", 1, -10, 10);
